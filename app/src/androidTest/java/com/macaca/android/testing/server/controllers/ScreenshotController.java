...
//TODO
public class ScreenshotController extends RouterNanoHTTPD.DefaultHandler {

    public static ScreenshotController getScreenshot;

    static {
        getScreenshot = new ScreenshotController() {
            @Override
