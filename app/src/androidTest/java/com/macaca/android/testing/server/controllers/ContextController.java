...
//TODO
public class ContextController extends RouterNanoHTTPD.DefaultHandler {

    public static ContextController getContext;
    public static ContextController setContext;
    public static ContextController getContexts;

    static {
        getContext = new ContextController() {
            @Override
        ...
        setContext = new ContextController() {
            @Override
            public NanoHTTPD.Response get(RouterNanoHTTPD.UriResource uriResource, Map<String, String> urlParams, NanoHTTPD.IHTTPSession session) {
                String sessionId = urlParams.get("sessionId");
                return NanoHTTPD.newFixedLengthResponse(getStatus(), getMimeType(), new Response(Status.NoSuchElement, sessionId).toString());
