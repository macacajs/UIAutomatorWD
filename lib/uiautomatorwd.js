...
exports.APK_BUILD_PATH = path.join(__dirname, '..', 'app', 'build', 'outputs', 'apk', 'androidTest', 'debug', 'app-debug-androidTest.apk');
exports.TEST_APK_BUILD_PATH = path.join(__dirname, '..', 'app', 'build', 'outputs', 'apk', 'debug', 'app-debug.apk');
